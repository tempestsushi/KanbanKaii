...
export function AuthPage() {
  ...
  return (
    <main className="relative min-h-dvh overflow-auto bg-violet-100 px-4 pb-[max(2rem,env(safe-area-inset-bottom))] pt-16 sm:px-6">
      <a
        href="/"
      ...
      <div className="mx-auto grid min-h-[calc(100dvh-6rem)] max-w-5xl overflow-hidden rounded-2xl border border-violet-200 bg-white shadow-xl lg:grid-cols-[1.05fr_0.95fr]">
        <AuthBrandPanel />
